...
class PaginationExtension extends \Twig_Extension
{
    ...
    protected $paginationTemplatePath;
     ...
     *
     * Set path and pagination template name, relative to the twig root
     * @param string Twig relative path and template name
     * @return void
     */
    public function setPaginationTemplateName($template)
    {
        $this->paginationTemplatePath = $template;
    }
    ...
    public function pagination()
    {
        ...
        return $this->environment->render($this->paginationTemplatePath, $values);
    }
}
